...
<div class="tv-info border-b border-gray-800">
    <div class="container mx-auto px-4 py-16 flex flex-col sm:flex-row">
        ...
        <div class="md:ml-24">
            ...
            <div class="flex flex-wrap iems-center text-gray-400 text-sm mt-1">
                        ...
                        <div class="modal-body px-8 py-8">
                            <div class="responsive-container overflow-hidden relative" style="padding-top:56.25%">
                                <iframe width="560" height="315" class="responsive-iframe absolute top-0
                                    left-0 w-full h-full" src="https://youtube.com/embed/{{ $tvshow['videos']['results']['0']['key'] }}"
            ...
            @foreach ($tvshow['cast'] as $cast)
                <div class="mt-8">
                    <a href="{{ route('actors.show', $cast['id']) }}">
                        ...
                        @else
                            <img src="https://via.placeholder.com/275x413" alt="poster" class="w-300">
                        @endif
                    </a>
                    <div class="mt-2">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-8">
                ...
                @foreach ($tvshow['images'] as $image)
                    <div class="mt-8">
                        ...
                        @else
                        <img src="https://via.placeholder.com/275x154" alt="poster" class="w-500">
                        @endif
                        </a>
                    </div>
                @endforeach
